...
export default function JoinBlindBoxModal({isOpen,onClose,onConfirm,onConfirmWithSaved,venue}:Props){
  ...
  return (
    <div className="fixed inset-0 z-[90] bg-black/70 backdrop-blur-[12px] flex items-center justify-center p-4">
      <div className="w-full max-w-[460px] bg-[#F5F3EF] rounded-[28px] p-8 text-black">
