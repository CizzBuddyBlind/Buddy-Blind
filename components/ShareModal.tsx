...
export default function ShareModal({isOpen,onClose,title,url}:Props){
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black backdrop-blur flex items-end md:items-center justify-center p-0 md:p-4">
      <div className="w-full md:max-w-[420px] bg-neutral-900 border border-zinc-800 rounded-t-[28px] md:rounded-[28px] p-6">
