  ...
  return (
    <main className="bb-frame bg-ink pb-32 pt-10 text-fg md:pb-20">
      <article className="mx-auto w-full max-w-3xl">
        ...
        <div className="policy mt-8 space-y-6 text-sm leading-relaxed text-white/75 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:text-white [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-white [&_li]:mt-1 [&_ol]:list-decimal [&_ol]:space-y-1 [&_ol]:pl-5 [&_strong]:text-white/90 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5">
          {children}
        </div>
      </article>
    </main>
