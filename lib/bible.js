...
export function badgePaint(points, thresholds, plain = "dark") {
  const tier = tierFromPoints(points, thresholds);
  if (tier === "gold") return { tier, style: { backgroundColor: "#E6C15A", color: "#1a1408" } };
  if (tier === "silver") return { tier, style: { backgroundColor: "#E4E7EC", color: "#1a1408" } };
  if (tier === "bronze") return { tier, style: { backgroundColor: "#C68642", color: "#1a1208" } };
  if (plain === "light") return { tier, style: { backgroundColor: "#f5f5f5", color: "#0a0a0a" } };
  return { tier, style: { backgroundColor: "#262626", color: "#f6e7c1" } };
}
