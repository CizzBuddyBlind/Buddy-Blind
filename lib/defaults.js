export const SEED = {
  copy: {
    venues: {
      kickerLeft: "VENUES · RESTAURANTS",
      kickerRight: "A NEIGHBOURHOOD. A TIME. SEATS LEFT.",
      title: "Pick the place.",
      accent: "Leave the rest blind.",
      sub: "No faces, just places.\nEnough to WANT, enough uncertainty to be WORTH having.",
      footer: "THE PLACES · COLOURED PHOTOS · THE TABLE STAYS BLIND",
    },
    quick: {
      title: "I'm free now.",
    ...
    private: {
      ...
      kickerRight: "INTEREST → CONNECT",
      title: "Find your interest.",
      accent: "Meet your people.",
      sub: "Host creates the reason. You find your kind.",
    },
    how: {
      kicker: "HOW IT WORKS",
      title: "How it",
  ...
  events: [
    ...
    { id: "tattoo-talk", kind: "private", name: "Tattoo & Talk", typeLabel: "INK STORIES", hostLabel: "Blind with Mina", upcomingLabel: "1 upcoming", spots: 6, hidden: false, imageUrl: "https://images.unsplash.com/photo-1568515045052-f9a854d70bfd?auto=format&fit=crop&w=1200&q=80" },
