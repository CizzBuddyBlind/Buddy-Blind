...
const PAGES = {
  ...
  PROFILE: [
    {key:'profile_buddies_title', label:'Buddies title'},
    {key:'profile_comments_title', label:'Comments title'},
    {key:'profile_rate_btn', label:'Rate someone btn'},
    {key:'profile_points_label', label:'Points label'},
    {key:'profile_points_desc', label:'Points desc'},
    {key:'profile_progress', label:'Progress 342/500'},
    {key:'profile_progress_desc', label:'Progress desc'},
    {key:'profile_perk1', label:'Perk 100 pts'},
    {key:'profile_perk2', label:'Perk 300 pts'},
    {key:'profile_perk3', label:'Perk 500 pts'},
    {key:'profile_vibe_label', label:'Vibe label'},
    {key:'profile_vibe_quote', label:'Vibe quote'},
    {key:'profile_vibe_btn', label:'Vibe btn'},
    {key:'profile_footer', label:'Footer'},
  ],
  GLOBAL_COLORS: [
