...
export default function Admin(){
  ...
  const add=async()=>{ if(!form.name) return; await supabase.from('restaurants').insert(form); setForm({name:'', cuisine:'', description:'', location:'', price_range:'$$', opening_hours:''}); load() }
  return (
    <main className="min-h-screen bg-black text-white p-8">
      <h1 className="text-3xl font-black">Bible Admin</h1>
      ...
      <button onClick={add} className="mt-4 bg-white text-black px-6 py-2 rounded font-bold">Add Restaurant</button>
