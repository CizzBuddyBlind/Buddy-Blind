  ...
  return (
    <div className="min-h-screen bg-black text-white pt-16">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="mt-4 text-sm text-zinc-500 max-w-xl">Host creates attraction and download reasons Six cards six different photos comedian tattoo chef wine mahjong tea hiking golden hour Photos always coloured hover turns text orange</p>
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {PRIVATE_DATA.map(v=>(
            <div key={v.id} className="bg-neutral-900 border border-zinc-800 rounded-3xl p-3 group hover:border-zinc-700">
              <div className="relative overflow-hidden rounded-2xl h-80">
                <img src={v.img} alt={v.title} className="w-full h-full object-cover"/>
                <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-black bg-opacity-70 backdrop-blur text-xs">{v.badge}</div>
              </div>
              <div className="p-3">
